...
describe("formatWatchDuration", () => {
  it("affiche 0 heure pour une durée nulle", () => {
    expect(formatWatchDuration(0)).toBe("0 heure");
  });
  ...
  it("affiche mois, jours et heures pour une durée dépassant un mois", () => {
    const minutes = (30 * 24 + 24 + 3) * 60;
    expect(formatWatchDuration(minutes)).toBe("1 mois 1 jour 3 heures");
  });
